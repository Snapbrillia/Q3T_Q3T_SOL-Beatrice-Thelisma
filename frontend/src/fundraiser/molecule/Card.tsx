...
const Card = ({ active,title,result,subText,icon }:{active?:boolean,result?:string,title:string,subText?:string, icon?:any}) => {
  return (
    <div className="flex gap-[10px] bg-white rounded-[20px] p-[20px] py-[30px] cursor-pointer border-l-[1px] sborder-r-[1px] border-solid sborder-primary_color shadow-light_shadow w-[28%] ehovher:bg-[black] ">
