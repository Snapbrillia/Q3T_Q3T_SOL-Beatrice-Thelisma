...
pub struct Contribute<'info> {
    ...
    #[account(
        mut,
        has_one = campaign_mint_to_raise,
        seeds = [b"fundraiser-grav.id".as_ref(), fundraiser.maker.as_ref()],
    ...
    #[account(
        init_if_needed,
        payer = contributor,
        seeds = [b"contributor-grav.id", fundraiser.key().as_ref(), contributor.key().as_ref()],
        bump,
    ...
    #[account(
        mut,
        associated_token::mint = fundraiser.campaign_mint_to_raise,
